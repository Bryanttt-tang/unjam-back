...
from angle import friedrichs_angle, friedrichs_angle_corrected
if __name__ == "__main__":
    ...
    # Example usage:
    print('+++++')
    # Use the corrected Friedrichs angle function
    cosine_angle = friedrichs_angle_corrected(h_dis, P_ker)
